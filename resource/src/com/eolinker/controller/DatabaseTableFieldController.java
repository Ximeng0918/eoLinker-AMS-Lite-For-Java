...
public class DatabaseTableFieldController
{
	...
	public Map<String, Object> addField(DatabaseTableField databaseTableField)
	{
		...
		if (databaseTableField.getTableID() == null || (databaseTableField.getTableID() != null
				&& !databaseTableField.getTableID().matches("^[0-9]{1,11}$")))
		{
		...
		else if (databaseTableField.getIsNotNull() == null || (databaseTableField.getIsNotNull() != null
				&& !databaseTableField.getIsNotNull().matches("^[0-9]{1}$")))
		{
			map.put("statusCode", "240004");
			return map;
		}
		else if (databaseTableField.getIsPrimaryKey() == null || (databaseTableField.getIsPrimaryKey() != null
				&& !databaseTableField.getIsPrimaryKey().matches("^[0-9]{1}$")))
		{
			map.put("statusCode", "240004");
			return map;
		}
	...
	public Map<String, Object> editField(DatabaseTableField databaseTableField)
	{
		...
		if (databaseTableField.getFieldID() == null || (databaseTableField.getFieldID() != null
				&& !databaseTableField.getFieldID().matches("^[0-9]{1,11}$")))
		{
			map.put("statusCode", "240007");
			return map;
		}
