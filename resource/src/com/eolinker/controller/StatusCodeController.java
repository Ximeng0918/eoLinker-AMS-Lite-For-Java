...
public class StatusCodeController
{
	...
	public Map<String, Object> addStatusCodeByExcel(HttpServletRequest request,HttpServletResponse response, Integer groupID, Integer projectID, @RequestParam(value="filename") MultipartFile file)
	{
		Map<String, Object> map = new HashMap<String, Object>();
		if(file == null)
		{
		...
		else
		{
			...
			boolean result = statusCodeService.addStatusCodeByExcel(projectID, groupID, userID, inputStream);
			if (result)
			{
				map.put("statusCode", "000000");
			}
